...
const Header = () => {
  ...
  return (
    <header className={`shadow-green-500/50 z-10 shadow-2xl fixed w-full h-15 p-7 flex justify-between text-white  md:bg-black/[.06]  ${openMenu ? 'bg-black ':'md:bg-black/[.06]'}`}>
